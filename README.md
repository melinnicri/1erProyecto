...
Los 3 archivos originales se encuentran en “DataBase”, como también el diccionario de datos (item está en [Drive](https://drive.google.com/file/d/1RjeZFwJ00dQ1Kt99STR8KOYtnTTyVqkj/view?usp=drive_link))
1) games.ipynb guarda First_Game_genres.csv y First_Game_tags.csv
2) items.ipynb guarda Third_Users.csv [Drive](https://drive.google.com/drive/folders/1by8sjGzQGZSmVgVA7kMcuJH0QTlOE2kt?usp=drive_link)
